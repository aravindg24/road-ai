...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-300",
  {
    variants: {
      variant: {
        default: "bg-gray-900 text-gray-50 hover:bg-gray-900/90 shadow-sm dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90",
        destructive:
          "bg-red-600 text-white hover:bg-red-700 shadow-sm dark:bg-red-600 dark:hover:bg-red-700",
        outline:
          "border border-gray-300 bg-white hover:bg-gray-50 hover:text-gray-900 dark:border-gray-600 dark:bg-[#292929] dark:hover:bg-gray-800 dark:hover:text-gray-50",
        secondary:
        ...
        success: "bg-green-600 text-white hover:bg-green-700 shadow-sm hover:shadow-md dark:bg-green-600 dark:hover:bg-green-700",
        purple: "bg-purple-600 text-white hover:bg-purple-700 shadow-sm hover:shadow-md dark:bg-purple-600 dark:hover:bg-purple-700",
      },
      size: {
