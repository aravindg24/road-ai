...
import VideoLab from "./components/tabs/VideoLab";
import { Search as SearchIcon, Trash2, Plus, Replace as ReplaceIcon, Film } from "lucide-react";
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <div className="border-b border-gray-200 dark:border-gray-700 mb-8 -mx-4 lg:-mx-8 px-4 lg:px-8 overflow-x-auto hide-scrollbar bg-white dark:bg-[#292929]">
                    <TabsList className="w-full justify-start h-auto p-0 bg-transparent min-w-max lg:min-w-0">
                      ...
                      <TabsTrigger value="video" className="px-5 sm:px-6 py-3.5 data-[state=active]:bg-transparent whitespace-nowrap text-sm font-medium">
